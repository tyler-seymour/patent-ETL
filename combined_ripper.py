...
#read in patent ids
with open("244_cleaned.csv", "r") as f:
...
lookup = "SELECT * FROM ipinformatics.patentsview_us_patent_citation WHERE patent_id IN("
count1 = 0
...
initial_frame.to_json("244_citations.json", orient='records', lines=True)